...
A comprehensive mathematical understanding of all WarFrame damage sources. 
## Introduction
...
## Missing Features
As this project is in early stages of development much has not yet been implemented. Additionally some effects create highly complex interactions that are not obvious e.g. in-game bugs etc. To speed up development these have been delayed to be implemented at a later date.
- Elemental mods
- Galvanized mods
- Augment mods

### Delayed (due to complexity)
- Melee Afflictions
- Melee Influence
## Bugs
